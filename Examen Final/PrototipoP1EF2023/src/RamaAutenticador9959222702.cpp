...
RamaAutenticador9959222702::RamaAutenticador9959222702()
{
    //ctor
}
...
string RamaAutenticador9959222702::setUusuario(string nombre) { // Se define el método setUsuario, que recibe como parámetro un usuario
    usuario = nombre; // Se asigna el valor del parámetro usuario al atributo usuario de la clase
}

string RamaAutenticador9959222702::getUusuario() { // Se define el método getUsuario
    return usuario; // Se devuelve el valor del atributo usuario de la clase
}

string RamaAutenticador9959222702::setContrasena(string pass) { // Se define el método setContrasena, que recibe como parámetro una contraseña
    pass = contrasena; // Se asigna el valor del parámetro contrasena al atributo contrasena de la clase
}

string RamaAutenticador9959222702::getContrasena(){ // Se define el método getContrasena
    return contrasena; // Se devuelve el valor del atributo contrasena de la clase
}

void RamaAutenticador9959222702::menuUsuarios(){
...
void RamaAutenticador9959222702::ingresarUsuarios(){
    system("cls");
...
void RamaAutenticador9959222702::desplegarUsurios()
{
...
void RamaAutenticador9959222702::modificarUsuarios()
{
	system("cls");
...
void RamaAutenticador9959222702::borrarUsurios()
{
	system("cls");
...
bool RamaAutenticador9959222702::verificarUsuario() {
...
string RamaAutenticador9959222702::getUsuarioAutenticado() {
